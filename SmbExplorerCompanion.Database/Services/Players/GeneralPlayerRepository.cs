...
public class GeneralPlayerRepository : IGeneralPlayerRepository
{
    ...
    public async Task<List<PlayerFieldingRankingDto>> GetPlayerFieldingRankings(int seasonId,
    ...
    public async Task<GameStatDto> GetLeagueAverageGameStats(int seasonId,
        bool isPitcher,
    ...
    public async Task<PlayerGameStatPercentileDto> GetPlayerGameStatPercentiles(int playerId,
        int seasonId,
        bool isPitcher,
        int? pitcherRoleId = null,
        CancellationToken cancellationToken = default)
    ...
    public async Task<PlayerKpiPercentileDto> GetPlayerKpiPercentiles(
        int playerId,
        int seasonId,
        bool isPitcher,
        int? pitcherRoleId = null,
    ...
    public async Task<PlayerBaseDto> GetRandomPlayer()
    {
